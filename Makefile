...
zip_file = Audiobookshelf_Sync_v$(version).zip
zip_contents = about.txt LICENSE plugin-import-name-ABS.txt *.py *.md images/*.png
plugin_index_file_to_upd = pluginIndexAudiobookshelfSync.txt
